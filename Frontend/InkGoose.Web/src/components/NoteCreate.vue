<template>
    <teleport to="body">
        <div class="absolute sticky top-0 inset-0 overflow-y-auto bg-black bg-opacity-50" v-if="isOpen">
            <div class="flex items-start justify-center h-full mt-24 text-center">
